...
/// <reference path="../../sb/pixi/display/Container.ts" />
(function (adservio) {
    class ModalNotificationScreen extends sb.pixi.display.Container {
        constructor(width, height, parentContainer, assets) {
            super(width, height);
            ...
            this.notify = (message, dismissText, dismissIconTexture, dismissCallback) => {
    ...
    adservio.ModalNotificationScreen = ModalNotificationScreen;
    class ModalScreenButton extends sb.pixi.display.Container {
        constructor(bgTexture, height = 50) {
            super();
            this._padding = 5;
            this.updateSize = () => {
...
//# sourceMappingURL=ModalNotificationScreen.js.map