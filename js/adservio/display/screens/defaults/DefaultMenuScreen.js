var adservio;
(function (adservio) {
    class DefaultMenuScreen extends adservio.Screen {
        constructor() {
            super();
            this._menuButtonHeight = 40;
            this.init = () => {
            ...
            this.screenActivated_handler = (gameState) => {
            ...
            this.toggleGameSound_handler = (gameState) => {
                if (this.engine.soundManager.muted) {
                    //unmute
            ...
            this.startGameButton_handler = () => {
                //this.disableButtons();
                this.engine.switchToScreen("GAME_SCREEN");
            };
            this.restartGame_handler = () => {
                //this.disableButtons();
    ...
    adservio.DefaultMenuScreen = DefaultMenuScreen;
})(adservio || (adservio = {}));
//# sourceMappingURL=DefaultMenuScreen.js.map